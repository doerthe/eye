...
This can be seen in [External Triple Code](https://github.com/josd/etc).  
...
* In [External Triple Code](https://github.com/josd/etc) the scope of implicit universals is the top level and  
...
* In [External Triple Code](https://github.com/josd/etc) variable substitutions naturally follow from the proof.  
