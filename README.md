...
* In [Euler Thinking Code](https://github.com/josd/etc) the scope of implicit universals is the top level and  
...
* In [Euler Thinking Code](https://github.com/josd/etc) variable substitutions naturally follow from the proof.  
