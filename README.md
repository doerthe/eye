...
This can be seen in [Eyeing Triple Content](https://github.com/josd/etc).  
...
* In [Eyeing Triple Content](https://github.com/josd/etc) the scope of implicit universals is the top level and  
...
* In [Eyeing Triple Content](https://github.com/josd/etc) variable substitutions naturally follow from the proof.  
