...
This can be seen in [External Triple Connections](https://github.com/josd/etc).  
...
* In [External Triple Connections](https://github.com/josd/etc) the scope of implicit universals is the top level  
...
* In [External Triple Connections](https://github.com/josd/etc) variable substitutions naturally follow from  
  the proof.  
