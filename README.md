...
This can be seen in [External Triple Constructs](https://github.com/josd/etc).  
...
* In [External Triple Constructs](https://github.com/josd/etc) variable substitutions naturally follow from the  
  proof.  
