...
- [EYE entailment test cases] (https://github.com/josd/eyeetc) verify [EYE releases] (http://josd.github.io/eye/RELEASE).
- EYE can be [installed manually] (http://josd.github.io/eye/INSTALL) on Linux, Windows and MacOSX.
